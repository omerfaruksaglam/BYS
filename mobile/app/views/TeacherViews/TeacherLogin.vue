  ...
  <Page class="page" title="" ref="login">
    ...
    <ScrollView>
      <FlexboxLayout class="form" flexDirection="column" justifyContent="center" alignItems="center">
        ...
        <label class="label">Ogretim elemanı numarası</label>
        <TextField v-model="teacherNumber" class="input-field" @blur="onTeacherBlur" />
...
import TeacherAnaekran from '~/views/TeacherViews/TeacherAnaekran.vue'
...
export default {
  ...
  methods: {
    ...
    async onLogin() {
      if (this.teacherNumber == null || this.selectedBolumId == null || this.sifre == null) {
