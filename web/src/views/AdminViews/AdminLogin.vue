        ...
        <div class="login-container">
            ...
            <form @submit.prevent="onLogin">
                <div class="form-group">
                    <label for="adminNumber">Yönetici Numarası</label>
                    <input type="text" id="adminNumber" v-model="adminNumber" required @blur="onAdminNumberBlur">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" v-if="adminNumber">
...
.form-group {
    margin: 20px;
    /* Yukarıdan ve aşağıdan 20px, yanlardan 0px boşluk bırak */
}
...
button {
    ...
    cursor: pointer;
    margin-top: 10px;
    /* Giriş yap butonunu yukarıda 10px boşluk bırak */
}</style>
