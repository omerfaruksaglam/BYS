<template>
  <div class="login-box">
    ...
    <div class="login-container">
      <h1>Öğretim Elemanı Girişi</h1>
      <form @submit.prevent="onLogin">
        <div class="form-group">
          <label for="teacherNumber">Öğretim Elemanı Numarası</label>
          <input type="text" id="teacherNumber" v-model="teacherNumber" required @blur="onTeacherNumberBlur">
        </div>
        <div class="form-group">
        ...
        <div class="form-group" v-if="teacherNumber">
