 ...
 decryptData(encryptedData) {
  ...
  return JSON.parse(bytes.toString(cryptoJs.enc.Utf8))
        ...
        goToSubskillforStatistics(skill) {
            this.$router.push({ name: 'studentstatisticsubskills', query: { skill: this.encryptData(skill), year: this.encryptData(this.sinif), student: this.encryptData(this.student), bolumInfo: this.encryptData(this.bolumInfo), secondGrader: this.encryptData(this.grader), secondGraderNotVerebilirmi: this.encryptData(this.graderNotVeriyormu) } });
