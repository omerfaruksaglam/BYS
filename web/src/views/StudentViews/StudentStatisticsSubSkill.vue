 ...
 decryptData(encryptedData) {
  ...
  return JSON.parse(bytes.toString(cryptoJs.enc.Utf8))
        ...
        goToSubskillSteps(subskill) {
            ...
            this.$router.push({ name: "studentstatisticsteps", query: { notVer: this.encryptData(this.notVer), subskill: this.encryptData(subskill), year: this.encryptData(this.year), student: this.encryptData(this.student), bolumInfo: this.encryptData(this.bolumInfo), skill: this.encryptData(this.skill), secondGrader: this.encryptData(this.secondGrader), secondGraderNotVerebilirmi: this.encryptData(this.secondGraderNotVeriyormu) } });
        },
