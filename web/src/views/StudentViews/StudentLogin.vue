        ...
        <div class="login-container">
            ...
            <form @submit.prevent="onLogin">
                <div class="form-group">
                    ...
                    <input type="text" id="studentNumber" v-model="studentNumber" required @blur="onStudentNumberBlur">
                </div>
                <div class="form-group">
                ...
                <div class="forgot" @click="forgotAlert"> 
                 ...
                 <div class="form-group" v-if="studentNumber">
  ...
  return JSON.parse(bytes.toString(cryptoJs.enc.Utf8))
      ...
      .then(data => {
        if(data != null){
          ...
          this.$router.push({name:'studenthome',query:{bolumInfo:this.encryptData(data.bolumInfo)}});
        }else{
